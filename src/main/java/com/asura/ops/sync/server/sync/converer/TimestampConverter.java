package com.asura.ops.sync.server.sync.converer;
...
public class TimestampConverter implements CustomConverter<SchemaBuilder, RelationalColumn> {
    ...
    public String strDatetimeFormat, strDateFormat, strTimeFormat, strTimestampFormat;
    public Boolean debug;

//    private final SchemaBuilder datetimeSchema = SchemaBuilder.string().optional().name("oryanmoshe.time.DateTimeString");

    private SimpleDateFormat simpleDatetimeFormatter, simpleDateFormatter, simpleTimeFormatter, simpleTimestampFormattter;
    ...
    public void configure(Properties props) {
        ...
        this.strTimestampFormat = props.getProperty("format.timestamp", DEFAULT_TIMESTAMP_FORMAT);
        this.simpleTimestampFormattter = new SimpleDateFormat(this.strTimestampFormat);
        ...
        this.simpleTimestampFormattter.setTimeZone(TimeZone.getTimeZone("UTC"));
    ...
    public void converterFor(RelationalColumn column, ConverterRegistration<SchemaBuilder> registration) {
        ...
        if (SUPPORTED_DATA_TYPES.stream().anyMatch(s -> s.equalsIgnoreCase(column.typeName()))) {
            boolean isTime = ("time".equalsIgnoreCase(column.typeName()) || "timestamp".equalsIgnoreCase(column.typeName()));
            ...
            registration.register(SchemaBuilder.string().optional(), rawValue -> {
                ...
                switch (column.typeName().toLowerCase()) {
                    ...
                    case "timestamp":
                        return this.simpleTimestampFormattter.format(dateObject);
                    default:
